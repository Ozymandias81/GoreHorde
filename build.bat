...
TITLE Gore: Horde Of Titans Compiler - Thanks Tiger!
...
EXPLORER https://github.com/Ozymandias81/GoreHorde
ECHO.
GOTO :EOF
...
IF %featuresGit% NEQ True (
    ...
    IF "%projectName%" NEQ "gorepk3d" SET "projectName=gorepk3d"
    GOTO :EOF
)
...
REM Avoid redundancy
IF "%projectName%" NEQ "gorepk3d-%GitCommitHash%" SET "projectName=gorepk3d-%GitCommitHash%"
GOTO :EOF
